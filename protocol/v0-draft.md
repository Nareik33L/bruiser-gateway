...
| DRY_RUN | `BRUISER_MODE=dry-run` / `enforce_percent=0`; `GET /v1/admin/dry-run` | yes — 100% observe, 0% enforce |
| RAMP | `enforce_percent` + `scope` on controls | yes — customer-stable progressive enforcement |
